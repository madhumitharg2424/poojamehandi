...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pooja Mehandi — premium bridal and party mehandi artist in Mylapore, Chennai. Traditional, Arabic, and South Indian designs with 100% organic henna." },
      { name: "author", content: "Pooja Mehandi" },
